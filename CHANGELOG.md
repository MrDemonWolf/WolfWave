...
- **WolfWave can talk to Apple Music again.** Nightly builds from August 4, 2026 onward couldn't reach Music.app at all. The now-playing card sat on "Nothing playing right now" while a song played, the request queue never advanced to the next song, `!skip` and the tray play/pause did nothing, and Song Requests setup kept sending you back to step one. Stable 2.0.1 was never affected. Music still stays closed when you close it.
