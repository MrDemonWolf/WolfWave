...
- **Settings Backups**. When you export your settings, WolfWave writes a plain JSON file to the location you choose. Backups contain preferences only — they never include Twitch tokens, account identifiers, the widget access token, or anything else from the Keychain.
