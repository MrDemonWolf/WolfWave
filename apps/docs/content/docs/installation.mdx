...
**Add a now-playing overlay to OBS.** Turn on the widget, copy the localhost URL, and paste it into OBS as a Browser Source. Details in the [widget guide](/docs/widget).
...
**Click OK when macOS asks for Apple Music access.** This one is required. It's how WolfWave reads the song that's playing.
...
<Cards>
  <Card title="Features & how-to" href="/docs/features" description="What WolfWave does and how to use it." />
