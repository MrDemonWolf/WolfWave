---
title: Security
description: How WolfWave protects Twitch and local WebSocket credentials with macOS Keychain, App Sandbox, OAuth Device Code flow, and signed updates.
keywords:
  - wolfwave security
...
ogDescription: Credentials are stored in macOS Keychain and sent only to the services you enable. App Sandbox, OAuth Device Code, and signed updates.
ogChips:
  - Keychain
  - App Sandbox
  - OAuth
  - EdDSA
ogEyebrow: Credentials stay safe
---
