...
extension AppConstants {
    ...
    nonisolated enum Twitch {
        ...
        /// OAuth scope for posting chat announcements (custom commands set to "Announcement").
        static let announcementsScope = "moderator:manage:announcements"
        ...
        static let allScopes = chatScopes + [channelPointsScope, bitsScope, pollsScope, announcementsScope]
