...
- **Monitors/** - Apple Music playback monitoring. `AppleMusicSource.swift` uses ScriptingBridge, distributed notifications, and 5s fallback polling (throttled in low-power mode), and reports updates through `PlaybackSourceDelegate.swift`.
